...
export const HelpPopup: React.FC<HelpPopupProps> = ({ closePopup }) => {
  ...
  return (
    <div className="popup-container">
      ...
      <h2>Battle Sweep</h2>
          <p className="game-synopsis">Battle Sweeper is an exciting and strategic two-player board game that combines the classic elements of Minesweeper and Battleship. In this game, players become naval commanders who must strategically deploy hidden mines on their opponent's grid while also skillfully navigating their own minefield.</p>
          <h2>How To Play</h2>
