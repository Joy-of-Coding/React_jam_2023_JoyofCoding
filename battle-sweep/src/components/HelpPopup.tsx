  ...
  return (
    <div className="popup-container">
      ...
      <h2>Capture the Crabs</h2>
          <p>Capture the Crabs is an exciting and strategic two-player game that combines the classic elements of Minesweeper and Battleship. In this game, players must strategically deploy hidden crabs on their opponent's grid while also skillfully navigating their own lava field.</p>
          <h2>How To Play</h2>
          <p>
            <ul>
              ...
              <li><b>Setting traps:</b> The objective of the game is to trap as many crabs as you can.  To trap a crab you must first place a trap it by clicking on the trap button and then clicking the tile of the lava field where the crab is.  Deselect the trap button and click the same tile to trigger the trap and catch the crab.</li>
